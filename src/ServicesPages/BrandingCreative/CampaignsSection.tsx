...
const CampaignsSection = () => {
  ...
  return (
    <section className="relative w-full py-24 md:py-32 flex justify-center overflow-hidden bg-[#1e1e1e] text-white">
      {/* Background Image */}
      <Image
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="space-y-6 max-w-2xl text-[17px] md:text-[19px] font-light leading-relaxed text-gray-300">
              <p>
