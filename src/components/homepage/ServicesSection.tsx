...
const services = [
  { number: "01", title: "Performance<br />Marketing", items: ["Affiliate Channels", "Cost Per Action", "ROI Model"] },
  { number: "02", title: "Social &<br />Content", items: ["Content Strategy", "Leverage Influencers", "Paid Social"] },
  { number: "03", title: "Web & Digital<br />Experience", items: ["UX/UI", "Front & Back End", "API Integration"] },
  { number: "04", title: "Branding &<br />Creative", items: ["Identity", "Campaigns", "Design Systems"] },
  { number: "05", title: "Public Relations<br />& Activations", items: ["Strategic PR", "Press Releases", "Events and Activation"] },
  { number: "06", title: "Strategy &<br />Consulting", items: ["Industry and Competitor Analysis", "Tailor-made Growth Strategies", "Targeted Ads and Email Campaigns"] },
]
