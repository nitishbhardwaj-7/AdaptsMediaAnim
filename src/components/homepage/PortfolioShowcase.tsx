...
export default function PortfolioShowcase({ projects: externalProjects, variant = "carousel" }: PortfolioShowcaseProps) {
  ...
  const prev = () => setCurrent((c) => (c - 1 + activeProjects.length) % activeProjects.length);
  ...
  if (isList) {
    return (
      <div ref={sectionRef} className="flex flex-col gap-8 md:gap-12 bg-[#12161c] font-['DM_Sans'] py-8 md:py-16">
  ...
  /* ── CAROUSEL MODE: Original homepage behavior ── */
  return (
